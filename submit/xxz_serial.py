...
Deltas = list(np.linspace(1.0, 1.0, 1, dtype=float))
Ws = list(np.linspace(1.0, 1.0, 1, dtype=float))
...
for W in Ws:
    for Delta in Deltas:
        ...
        local_path += \
            '/params_' + str(num_spins) + '_' + str(format(Delta, '0.4f')) + '_' + str(format(W, '0.4f')) + '_' + str(format(mu, '0.4f')) + '_' + str(drv_type) + '_' + str(format(T1, '0.4f')) + '_' + str(format(T2, '0.4f')) + '_' + str(quantity_index) + \
