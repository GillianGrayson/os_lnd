...
path = '/data/biophys/denysov/yusipov/os_lnd/regular/lfk/eigen_dense';
figures_path = '/home/denysov/yusipov/os_lnd/figures/lfk';
...
suffix = sprintf('%s_N(%d)_numSeeds(%d)', name, N, num_seeds_run);
