...
for W_id = 1:numWs
    ...
    for D_id = 1:numDeltas
        ...
        for n_id = 1:size(num_spins, 1)
            ...
            local_path = sprintf('n_%d/params_%0.4f_%0.4f_%0.4f_%d_%0.4f_%0.4f_%d/seeds_%d_%d_%d', ...
                ns, ...
                Delta, ...
                W, ...
                mu, ...
...
suffix = sprintf('serial(%0.4f_%0.4f_%d)_prm(%0.4f_%0.4f_%0.4f_%d_%0.4f_%0.4f)_j(%d)', ...
    serial_start, ...
    serial_shift, ...
    serial_num, ...
    Delta, ...
